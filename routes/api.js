...
let { findKodeDaerah, jadwalSholat } = require("./scrape/jadwal-sholat");
...
let { pitutur } = require("./scrape/berita");
...
let { instaDL } = require("./scrape/snapinsta");
...
let { loveTik } = require("./scrape/lovetik");
...
let { xnxxsearch } = require("./scrape/xnxx");
...
let { xnxxdl } = require("./scrape/xnxx");
